 ...
 *
 *
 * Operation: 'compute.interconnectAttachments.insert'
 * Endpoint Path: '/{project}/regions/{region}/interconnectAttachments'
 * Method: 'post'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/{project}/regions/{region}/interconnectAttachments',
        method: 'post',
