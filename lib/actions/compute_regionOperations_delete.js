 ...
 *
 *
 * Operation: 'compute.regionOperations.delete'
 * Endpoint Path: '/{project}/regions/{region}/operations/{operation}'
 * Method: 'delete'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/{project}/regions/{region}/operations/{operation}',
        method: 'delete',
